...
const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    image: "https://placehold.co/400x400/9b59b6/ecf0f1?text=D.C.",
  ...
  },
  {
    ...
    image: "https://placehold.co/400x400/e67e22/ecf0f1?text=E.R.",
        ...
        <div className="flex-shrink-0 w-32 h-32 rounded-full overflow-hidden mb-4 md:mb-0 md:mr-6 border-4 border-indigo-400/70 shadow-inner">
          <Image
            ...
            onError={(e: React.SyntheticEvent<HTMLImageElement>) => {
              ...
              e.currentTarget.src = "https://placehold.co/400x400/1e293b/94a3b8?text=N/A";
            }}
          />
        </div>
