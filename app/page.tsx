...
const COLOR_SECONDARY = '#4D3319'; // Walnut Brown (Sophistication/Accent)
...
// NOTE: This image is generated by the AI model.
const CAMPAIGN_BG_IMAGE = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAA+AAAAJgAQMAAADV/j1qAAAABlBMVEXsCgDuBQAAAFw/S2/AAAAEklEQVR4nO3BAQEAAADCoP1yP2UYAAAgfoADAAH9Bf6LAAAAAElFTkSuQmCC";

// --- SVG ICONS ---
const DesignIcon: FC = () => (
    // Stroke color set dynamically to primary color
    <svg className={`svg-icon w-8 h-8 stroke-2 text-[${COLOR_PRIMARY}]`} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path strokeLinecap="round" strokeLinejoin="round" d="M10 20l4-16m4 4l4 4m-4-4l-4 4m0 0l-4 4m4-4l4-4m-4 4l-4-4m-4 4l-4 4m4-4l-4-4"></path>
    </svg>
);
...
const SoftwareIcon: FC = () => (
    // Stroke color set dynamically to primary color
    <svg className={`svg-icon w-8 h-8 stroke-2 text-[${COLOR_PRIMARY}]`} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 17L9 20l-1.5 1h5.25v-2.25M15 17v2.25A2.25 2.25 0 0112.75 21H6.75A2.25 2.25 0 014.5 18.75V5.25A2.25 2.25 0 016.75 3h4.94L18.75 9V17H15z"></path>
    </svg>
);
...
const GadgetsIcon: FC = () => (
    // Stroke color set dynamically to primary color
    <svg className={`svg-icon w-8 h-8 stroke-2 text-[${COLOR_PRIMARY}]`} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 15M2 17V7a2 2 0 012-2h12a2 2 0 012 2v10a2 2 0 01-2 2H4a2 2 0 01-2-2z"></path>
    </svg>
);
...
const HeroSlider: FC = () => {
    const slides: Slide[] = [
        // Slide 1: New Campaign Banner (#MakeItHappen)
        {
            id: 1,
            content: (
        ...
        // Slide 2: Original Core Message
        {
            ...
            content: (
                <div className="flex flex-col items-center justify-center h-full">
                    <h2 className={`text-5xl sm:text-7xl ${HEADING_CLASSES} mb-6 leading-tight max-w-5xl mx-auto`}>
                        Technology <span className="text-primary">Simplified.</span> Built for Scale.
                    </h2>
                    <p className={`text-2xl text-gray-500 max-w-4xl mx-auto mb-10`}>
                        We deliver world-class **Designs**, **Custom AI Software**, and **Premium Gadgets**. Your all-in-one technology partner for high-impact projects.
                    </p>
                    <a href="#contact" className={`inline-block font-bold  bg-primary py-4 px-12 rounded-full text-lg shadow-2xl shadow-green-300/50 ${ctaButtonClasses}`}>
    ...
    return (
        <section className="relative w-full overflow-hidden h-[600px] sm:h-[700px] flex items-center justify-center transition-all duration-1000" id="hero-slider">
                ...
                {slides.map((slide, index) => (
                    <button 
                        ...
                        className={`w-3 h-3 rounded-full transition-all duration-300 ${
                            index === currentSlide ? 'bg-primary scale-125 shadow-md' : 'bg-white/50 hover:bg-white/80'
                        }`}
...
const Home: FC = () => {
    ...
    return (
        <div className="bg-base min-h-screen font-sans" style={{ backgroundColor: COLOR_BACKGROUND_BASE }}> 
            ...
            <header className="bg-white border-b border-gray-100 sticky top-0 z-20 shadow-sm">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
                    ...
                    <nav className="hidden md:flex space-x-10 text-gray-700 font-medium">
                        <a href="#services" className="hover:text-primary transition duration-200">Services</a>
                        <a href="#solutions" className="hover:text-primary transition duration-200">Solutions</a>
                        <a href="#process" className="hover:text-primary transition duration-200">Process</a>
                        {/* Updated to use primary color for border and text */}
                        <a href="#contact" className="px-4 py-2 rounded-full border-2 border-primary text-primary hover:bg-primary hover:text-white transition duration-230">Get Started</a>
                    </nav>
                </div>
            </header>
            ...
            {/* Uses Ghost White background */}
            <section id="process" className="py-24 bg-white" style={{ backgroundColor: 'white' }}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h3 className={`text-4xl ${HEADING_CLASSES} text-center mb-4`}>
                        Our Simplified Process
                    </h3>
                    <p className={`text-center mb-16 max-w-3xl mx-auto ${SUBTITLE_CLASSES}`}>
                        Complexity is removed. We focus on results using an agile, client-centric approach.
                    </p>

                    <div className="relative flex flex-col md:flex-row justify-between items-stretch space-y-12 md:space-y-0 md:space-x-8">
                        
                        {/* Step 1 */}
                        {/* Circles use primary Green */}
                        <div className="flex flex-col items-center p-8 bg-white rounded-2xl shadow-xl border border-gray-100 z-10 w-full">
                            <div className="w-16 h-16 flex items-center justify-center rounded-full bg-primary text-white font-black text-2xl mb-4 shadow-xl">1</div>
                            <h4 className="text-xl font-bold mb-2 text-charcoal">Define</h4>
                            <p className="text-gray-600 text-center text-sm">We listen and confirm your single biggest need across Design, Software, or Gadgets.</p>
                        </div>

                        {/* Step 2 */}
                        <div className="flex flex-col items-center p-8 bg-white rounded-2xl shadow-xl border border-gray-100 z-10 w-full">
                            <div className="w-16 h-16 flex items-center justify-center rounded-full bg-primary text-white font-black text-2xl mb-4 shadow-xl">2</div>
                            <h4 className="text-xl font-bold mb-2 text-charcoal">Develop</h4>
                            <p className="text-gray-600 text-center text-sm">Our expert team rapidly architects, builds, and tests the tailored solution in sprints.</p>
                        </div>

                        {/* Step 3 */}
                        <div className="flex flex-col items-center p-8 bg-white rounded-2xl shadow-xl border border-gray-100 z-10 w-full">
                            <div className="w-16 h-16 flex items-center justify-center rounded-full bg-primary text-white font-black text-2xl mb-4 shadow-xl">3</div>
                            <h4 className="text-xl font-bold mb-2 text-charcoal">Deploy</h4>
                            <p className="text-gray-600 text-center text-sm">We deploy the solution and provide local, dedicated support and training. Success realized.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="contact" className="bg-contrast py-20 text-white" style={{ backgroundColor: COLOR_BACKGROUND_CONTRAST }}>
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className={`mt-6 text-sm text-primary font-semibold ${isSubmitted ? 'animate-pulse' : 'hidden'}`}>
            ...
            {/* Footer */}
            {/* Uses Ghost White background */}
            <footer className="bg-gray-100 text-gray-600 py-10" style={{ backgroundColor: COLOR_BACKGROUND_BASE }}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-3 gap-8 text-sm">
                    ...
                    <div className="space-y-2">
                        ...
                        <p>Technology Simplified. Built for Nigeria&apos;s digital future.</p>
                    </div>

                    <div className="space-y-2">
                        <h5 className="font-bold text-charcoal mb-2 text-base">Quick Links</h5>
                        <ul className="space-y-1">
                            {/* Links use primary color on hover */}
                            <li><a href="#services" className="hover:text-primary transition">Services</a></li>
                            <li><a href="#solutions" className="hover:text-primary transition">Case Studies</a></li>
                    ...
                    <div className="space-y-2">
                        ...
                        <a href="#contact" className="text-primary font-semibold hover:underline transition">Click to Get Started</a>
                    </div>
                </div>
