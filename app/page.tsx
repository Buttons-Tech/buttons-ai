...
const CAMPAIGN_BG_IMAGE =
  "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAA+AAAAJgAQMAAADV/j1qAAAABlBMVEXsCgDuBQAAAFw/S2/AAAAEklEQVR4nO3BAQEAAADCoP1yP2UYAAAgfoADAAH9Bf6LAAAAAElFTkSuQmCC";
    ...
    // Slide 1: New Campaign Banner (#MakeItHappen)
    {
      ...
      content: (
        <div className="flex flex-col items-center justify-center h-full space-y-4">
          ...
          <a
            href="#contact"
            className={`mt-12 border border-green-300 inline-block font-bold py-4 px-12 rounded-full text-lg shadow-2xl shadow-green-500/50 hover:shadow-green-700/70 ${ctaButtonClasses}`}
          >
            Register Here
          </a>
        </div>
    ...
    // Slide 2: Original Core Message
    {
      ...
      content: (
        <div className="flex flex-col items-center justify-center h-full">
          <h2
            className={`text-5xl sm:text-7xl ${HEADING_CLASSES} mb-6 leading-tight max-w-5xl mx-auto`}
          >
            Technology <span className="text-primary">Simplified.</span> Built
            for Scale.
          </h2>
          <p className={`text-2xl text-gray-500 max-w-4xl mx-auto mb-10`}>
            We deliver world-class **Designs**, **Custom AI Software**, and
            **Premium Gadgets**. Your all-in-one technology partner for
          ...
          <div className="relative flex flex-col md:flex-row justify-between items-stretch space-y-12 md:space-y-0 md:space-x-8">
            ...
            <div className="flex flex-col items-center p-8 bg-white rounded-2xl shadow-xl border border-gray-100 z-10 w-full">
              ...
              <p className="text-gray-600 text-center text-sm">
                We listen and confirm your single biggest need across Design,
                Software, or Gadgets.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center p-8 bg-white rounded-2xl shadow-xl border border-gray-100 z-10 w-full">
              ...
              <p className="text-gray-600 text-center text-sm">
                Our expert team rapidly architects, builds, and tests the
                tailored solution in sprints.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center p-8 bg-white rounded-2xl shadow-xl border border-gray-100 z-10 w-full">
              ...
              <p className="text-gray-600 text-center text-sm">
                We deploy the solution and provide local, dedicated support and
                training. Success realized.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <input
              ...
              className="w-full p-4 rounded-xl text-white border border-green-300 focus:outline-none focus:ring-4 focus:ring-primary/50 transition duration-200"
              required
            />
            <input
              type="email"
            ...
            <textarea
              ...
              rows={4}
              className="w-full p-4 rounded-xl border border-green-300  text-white focus:outline-none focus:ring-4 focus:ring-primary/50 transition duration-200"
              required
            ></textarea>
            ...
            <button
              type="submit"
              className={`w-full font-bold py-4 rounded-xl bg-green-300 text-black text-lg shadow-xl shadow-green-500/30 `}
            >
              Send Request & Get a Quote
            </button>
          </form>
          <p
            className={`mt-6 text-sm text-primary font-semibold ${
